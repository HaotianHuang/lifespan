...
//
//// MARK: The following dictionaries are redundant because I ended upm hardcoding them into individual functions
//
//// Exercise
...
//
//    if 0..<0.5 ~= exercise{
//        model.exerciseValue = 0.5
//        print(model.exerciseValue)
